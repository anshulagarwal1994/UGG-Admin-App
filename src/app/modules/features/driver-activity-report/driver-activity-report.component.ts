...
export class DriverActivityReportComponent {
      ...
      .subscribe(
        (res) => {
          res.data.forEach((d: any) => {
            let chargingTime = new Date(d.chargingTime);
            d.chargingTime = chargingTime.toLocaleString('en-US', {timeZone: 'CST'});
          });
  ...
  downloadReport() {
    let csvData = this.ConvertToCSV(this.dataSource.data, ['name',
    'email',
    'mobile',
    'tenant',
    'site',
  ...
  ConvertToCSV(objArray: any, headerList: any) {
    ...
    let str = '';
    let row = 'Sr. No.,';
    let newHeaders = ['Name','Email', 'Mobile', 'Organization', 'Site', 'ChargePoint', 'Charging Time', 'Units Consumed (KwH)'];
